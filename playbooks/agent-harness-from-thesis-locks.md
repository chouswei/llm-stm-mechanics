...
- Empirical harnesses: `experiments/` (P1/P2/P3, `markov-w-only/`, `s13-seams/`; locked bake-off Results: `experiments/shapewalk-vs-rag/`, `experiments/shapewalk-vs-rag-embed/`, `experiments/shapewalk-vs-rag-tgt0/` lexical T>0 PASS)
