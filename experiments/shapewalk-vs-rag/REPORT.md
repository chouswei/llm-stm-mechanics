...
**PASS** under PROTOCOL: $n\_{\mathrm{triple}}\ge 30$; both contrasts positive with CI excluding $0$; coeffs/scorer unchanged.
...
Note: $n\_{\mathrm{pair\_walk\_rag}}=83$ equals $n\_{\mathrm{triple}}$ on this run (every walk+RAG equal-quality row was also dump-perfect).
