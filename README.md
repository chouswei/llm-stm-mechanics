...
Empirical harnesses for §10: [`experiments/`](experiments/) (P1/P2/P3 synthetic goldfish; P1 LLM-answer quality under `experiments/p1-llm/` with the **full-gold** scorer — do not cite the invalid gold∩W 200/200 run; P3 generation half under `experiments/p3-gen/`; 0.19.4 honesty $c$ confirmation under `experiments/p3-gen-0194/`).
