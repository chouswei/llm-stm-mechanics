...
Empirical harnesses for §10: [`experiments/`](experiments/) (P1/P2/P3 synthetic goldfish; P1 human-reviewed under `experiments/p1-hr/` with Sage author-blind **ACCEPT after regen** recorded in `experiments/p1-blind/`; P1 LLM-answer quality under `experiments/p1-llm/` with the **full-gold** scorer — do not cite the invalid gold∩W 200/200 run; P3 generation half under `experiments/p3-gen/`; 0.19.4 honesty $c$ confirmation under `experiments/p3-gen-0194/`; P3 $T>0$ CANONICAL band under `experiments/p3-tgt0/`). P1 $T>0$ remains open.
